...
<body class="bg-bg-project font-poppins">
    ...
    <div class="content">
        <div class="content" style="display: flex; align-items: center; justify-content: space-between;">
            ...
            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#agregar-administrador">Agregar</button>
        </div>
        ...
        <table class="table table-bordered" id="dataTable">
            ...
            <tbody>
                ...
                if (empty($busqueda)) {
                    $consulta = mysqli_query($conexion, "SELECT * FROM administradores");
                } else {
                ...
                <tr>
                    ...
                    <td>
                        <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#editar-administrador<?php echo $fila['id_admin']; ?>">
                            <i class="fa fa-edit "></i>
                        </button>
                    </td>
                    <?php include "Funciones/editar-a.php"; ?>
                <?php endwhile; ?>
            </tbody>
        </table>
    </div>

    <?php include "Funciones/agregar-administrador.php"; ?>
