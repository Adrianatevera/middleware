...
<body class="bg-bg-project font-poppins">
    ...
    <nav class="bg-white h-screen rounded-r-xl">
        ...
        <ul class="px-12">
            ...
            <li class="link-parent">
                <a class="flex gap-3 py-4" href="informes_receta.php">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <form action="DescargarReporte_x_receta_PDF.php" method="post" accept-charset="utf-8">
                    <div class="row">
                        <div class="col">
                            <input type="text" name="Num_receta" class="form-control" placeholder="Número de Receta" required>
                        </div>
                        <div class="col">
                            <button type="submit" class="btn btn-danger mb-2">Descargar Reporte</button>
                            <!-- Botón para abrir la ventana modal -->
<button type="button" class="btn btn-success" data-toggle="modal" data-target="#agregar-receta"> Agregar </button>
...
<!-- -->
        ...
        <table class="table table-bordered" id="dataTable">
            ...
            <tbody>
                ...
                $consulta = mysqli_query($conexion, "SELECT * FROM receta");
                while ($fila = mysqli_fetch_assoc($consulta)):
                ?>
                <tr>
                    <td><?php echo $fila['Num_receta']; ?></td>
                    <td><?php echo $fila['P_codigo']; ?></td>
                    <td><?php echo $fila['id_dueño']; ?></td>
                    <td><?php echo $fila['id_medico']; ?></td>
                    <td><?php echo $fila['Fecha']; ?></td>
                    <td><?php echo $fila['Medicamentos']; ?></td>
    ...
    <?php include "../Funciones/agregar-receta.php"; ?>
